...
if __name__ == '__main__':
    ...
    proc = DdsMessageProcessor(
        consumer=AppConfig.kafka_consumer(AppConfig()),
        producer=AppConfig.kafka_producer(AppConfig()),
        dds_repository=DdsRepository(AppConfig.pg_warehouse_db(AppConfig())),
        batch_size=100,
        logger=app.logger
    )
